...
* 🌸 [**Versión Kawaii**](https://ais-pre-zuhzshpfk53v2elx3nekk7-366529865543.europe-west2.run.app): Diseñada para una conexión emocional, con mensajes amigables y estética colorida.
* ⚙️ [**Versión Técnica (Seriota)**](https://ais-pre-dcriwrnpytpoi2i2tbx5or-366529865543.europe-west2.run.app/): Enfoque minimalista orientado a datos y monitorización de sistemas.
